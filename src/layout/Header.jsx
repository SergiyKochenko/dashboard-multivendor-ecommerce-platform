...
const Header = ({showSidebar, setShowSidebar}) => {
    return (
        ...
        <div className='flex justify-center items-center gap-8 relative'>
          ...
          <h2 className='text-md font-bold'>Sergiy Kochenko</h2>
          <span className='text-[14px] w-full font-normal'>Admin</span>
              </div>
              <img className='w-[45px] h-[45px] rounded-full overflow-hidden' src="http://localhost:3000/images/admin.jpg" alt="admin" />
